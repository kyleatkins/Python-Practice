...
#Teams stored in dictionary {Name:TotalPlayers}
teams = {}
...
class Global(object):
    ...
    def Player(self, name, number, position):
        ...
        print "Created %s as a player!" % name


	def add_player_to_team(name, team, position):
		if name in players:
			teams[Player.name] = Players.number
		else:
			print "Player not found, create Player() first"
